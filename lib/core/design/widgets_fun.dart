...
Widget cachedImage(String img,{double? rad,BoxFit boxFit=BoxFit.cover,bool smallImage=false,bool slider = false,double? height=220,double? width=double.infinity}){
  return ClipRRect(
  ...
  return Center(
    child: Container(
      ...
      child: LoadingIndicator(
        ...
        colors:  [Colors.black,color?? Colors.black.withOpacity(.5),],
      ),
    ),
  );
}
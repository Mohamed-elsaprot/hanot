...
import 'package:hanot/features/tabs_screen/model/category_model/CategoryModel.dart';
import 'item_card.dart';

class ProductsListBody extends StatelessWidget {
  const ProductsListBody({Key? key, required this.scrollController, required this.categoryModel, required this.last}) : super(key: key);
